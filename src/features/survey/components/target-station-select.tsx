    ...
    <div>
      ...
      <div className="relative">
        <select
          ...
          className={cn(
            "w-full appearance-none bg-slate-100 dark:bg-[#141b2b] text-slate-900 dark:text-slate-100 font-mono text-xs rounded-xl px-3.5 py-2.5 pr-8 focus:outline-none focus:border-blue-500/60 focus:ring-1 focus:ring-blue-500/30 border border-slate-200/80 dark:border-white/10 transition-all duration-150 shadow-inner",
      ...
      {error && <p className="font-mono text-xs text-rose-500 mt-1">{error}</p>}
    </div>
  );
}
